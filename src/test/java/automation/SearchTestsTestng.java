...
//        driver = new ChromeDriver();
    ...
    public void commonSearchTermResultsNotEmpty()
    {
        ...
        new WebDriverWait(driver, Duration.ofSeconds(5))
                .until(ExpectedConditions.presenceOfElementLocated(By.xpath(("//div[@class = 'header-search__panel opened']"))));
    ...
    public void searchResultsAreEmpty()
    {
        ...
        WebElement findButton = driver.findElement(By.xpath(("//button[@class = 'header-search__submit']")));
        findButton.click();
        WebElement emptyResultsError = driver.findElement(By.xpath("//div[@class = 'search-results__exception-message search-results--empty-result']"));
